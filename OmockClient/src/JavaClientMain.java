...
public class JavaClientMain extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					JavaClientMain frame = new JavaClientMain();
	...
	class Myaction implements ActionListener // 내부클래스로 액션 이벤트 처리 클래스
	{
		...
		public void actionPerformed(ActionEvent e) {
			...
			MainFrame main = new MainFrame(username, ip_addr, port_no);
			//JavaClientGameFrame view = new JavaClientGameFrame(username, ip_addr, port_no);
			dispose();
		}
	}
}
